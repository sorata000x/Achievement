...
from PyQt6.QtWidgets import QWidget, QPushButton, QScrollArea, QVBoxLayout
...
class AchievementMenuPage(QWidget):
    def __init__(self, parent=None):
        ...
        self.achievement_collection_button.setFixedWidth(226)
        self.achievement_collection_button.setFixedHeight(50)
        self.achievement_collection_button.move(3, 33)
